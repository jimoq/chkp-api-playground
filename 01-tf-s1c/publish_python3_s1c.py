...
def main():
    ...
    # Get the cloud management ID from the environment variable CHECKPOINT_CLOUD_MGMT_ID
    checkpoint_cloud_mgmt_id = os.getenv('CHECKPOINT_CLOUD_MGMT_ID')
    if not checkpoint_cloud_mgmt_id:
        print("Error: CHECKPOINT_CLOUD_MGMT_ID environment variable is required for Smart-1 Cloud")
        sys.exit(1)
